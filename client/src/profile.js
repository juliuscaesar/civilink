...
class Profile extends React.Component {
    constructor(props) {
         ...
         */
        this.state = {errorMessage: '', displayError: false, profile: [], following: [], followers: [],
            communities: [], feed: []};
    ...
    parseInfoResponse(error, response) {
        switch(response.status) {
            case 200:
                this.setState({profile: response.body.profile, following: response.body.following,
                    communities: response.body.communities, feed: response.body.activity});
                break;
            case 203:
                this.setState({
                       ...
                       <div className="col-sm-4 col-md-4">
                         <div className="content-box">
                           <div className="headertext">
                               ...
                               <small>   @{this.state.profile.username}</small></div>
                           <hr/>
                           <center>
