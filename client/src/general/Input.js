...
class Input extends React.Component {
  constructor(props) {
    ...
    // keep the input field's value and whether an error
    // should be visible in the state
  ...
  * Also saves the value to the form's state using the props.save function
  * passed in
  ...
  */
  ...
  /**
  * Renders the form group for this input component - including the label,
