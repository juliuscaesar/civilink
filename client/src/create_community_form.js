...
class CreateCommunityForm extends React.Component {
    ...
    /**
     * Validation for the email field - email cannot be empty and must be of the form of a valid email
    ...
    render(){
        return (
            <form onSubmit={this.submitAccount}>
                <Input label="Name" inputId="title" inputType="text"
                    name="title" save={this.setValue}
                    validation={CreateCommunityForm.nameValidation}/>
                <Input label="Description" inputId="desc" inputType="text"
                    name="desc" save={this.setValue}
                    validation={CreateCommunityForm.descValidation}/>
                <button type="submit" disabled={this.getDisabledProperty()} className={this.getButtonClass()} >Create Community</button>
            </form>
        );
    }
}
